		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="submit" @click="apiNewTask" type="button" class="btn btn-primary"
	...
	<table class="table">
		...
		<tbody>
			<tr v-for="(task, index) in tasks" class="alert" v-bind:class="{'alert-success': task.activo===0 }">
				...
				<td>
					<input type="text" :disabled="task.edit === 0"
				...
				<td class="text-center" scope="row">
					<button @click="editTask(task.id, index)" class="btn btn-sm "
						v-bind:class="{'btn-warning': task.edit===0, 'btn-success': task.edit===1 }">
						<i class="fa-solid "
							v-bind:class="{'fa-pen-to-square': task.edit===0, 'fa-floppy-disk': task.edit===1 }"></i>
					</button>
				</td>
				<td class="text-center" scope="row">
				...
				<td class="text-center" scope="row">
					<button @click="checkTask(task.id, index)" class="btn btn-sm "
						v-bind:class="{'btn-info': task.activo===1, 'btn-dark': task.activo===0 }">
						<i class="fa-solid "
							v-bind:class="{'fa-circle-check': task.activo===1, 'fa-rotate-left': task.activo===0 }"></i>
					</button>
				</td>
			</tr>
		</tbody>
