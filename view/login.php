				...
				<div class="col-lg-4 col-md-6 col-sm-8 mx-auto">
					...
					<div v-if="!registerActive" class="card p-5">
						...
						<form class="form-group" id="login">
							...
							<p>Don't have an account? <a href="#"
									@click="registerActive = !registerActive,  cleanInputs()">Sign up here</a>
							</p>
						</form>
					</div>
					...
					<div v-else class="card p-5">
						...
						<form class="form-group" id="register">
							<input v-model="name" name="name" type="text" class="form-control" placeholder="Name"
								required>
							...
							<input v-model="password" name="password" type="password" class="form-control"
								placeholder="Password" required>
							<input v-model="confirPassword" type="password" class="form-control"
								placeholder="Confirm Password" required>
							<input type="submit" class="btn btn-block col-12 btn-primary" @click="doRegister">
							<p>Already have an account? <a href="#"
									@click="registerActive = !registerActive, cleanInputs()">Sign in here</a>
							</p>
						</form>
					</div>
				</div>
